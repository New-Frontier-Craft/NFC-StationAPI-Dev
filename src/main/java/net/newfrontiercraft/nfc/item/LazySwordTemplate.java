...
public class LazySwordTemplate extends TemplateSwordItem implements CustomTooltipProvider {
    private final ToolTierEnum toolTierEnum;

    public LazySwordTemplate(Identifier identifier, ToolMaterial material, ToolTierEnum toolTierEnum) {
