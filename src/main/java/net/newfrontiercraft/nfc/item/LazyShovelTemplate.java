...
public class LazyShovelTemplate extends TemplateShovelItem implements CustomTooltipProvider {
    private final ToolTierEnum toolTierEnum;

    public LazyShovelTemplate(Identifier identifier, ToolMaterial material, ToolTierEnum toolTierEnum) {
