...
public class LazyAxeTemplate extends TemplateAxeItem implements CustomTooltipProvider {
    private final ToolTierEnum toolTierEnum;

    public LazyAxeTemplate(Identifier identifier, ToolMaterial material, ToolTierEnum toolTierEnum) {
