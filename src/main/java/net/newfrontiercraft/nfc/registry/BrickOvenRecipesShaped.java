...
public class BrickOvenRecipesShaped implements BrickOvenRecipe {

    public BrickOvenRecipesShaped(int i, int j, ItemStack[] itemStacks, ItemStack itemInstance, int time) {
